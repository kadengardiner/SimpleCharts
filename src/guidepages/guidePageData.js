const guidePageData = {
  schedule: {
    ...
    details: {
      1: 'Sign into the patient portal with your account information. If the portal does not show appointments right away, open the menu icon with three lines to find more options.',
